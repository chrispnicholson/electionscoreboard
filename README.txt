...
3) Navigate to this directory and find the scores.html file within the target/classes/templates directory and open this in a browser.
...
in both Javadoc and Confluence/Wiki. The percentages showing vote share are slightly inaccurate, as they are an average of the
percentages themselves. If I had more time, I would've taken the party's share of all votes so far, divided by the aggregate of all
votes and multiplied by 100 to get a more accurate percentage when adding constituency results.